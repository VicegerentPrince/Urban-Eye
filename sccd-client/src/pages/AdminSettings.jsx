...
import { FaSave, FaCog, FaBell, FaShieldAlt, FaDatabase, FaUsersCog } from 'react-icons/fa';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          >
            <div className="flex items-center mb-4">
              <FaShieldAlt className="text-emerald-500 mr-3 text-xl" />
          ...
          >
            <div className="flex items-center mb-4">
              <FaDatabase className="text-emerald-500 mr-3 text-xl" />
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <label className="text-gray-700">Auto-Assign Issues</label>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input 
                    type="checkbox" 
                    className="sr-only peer" 
                    checked={settings.system.autoAssignIssues}
                    onChange={(e) => handleSettingChange('system', 'autoAssignIssues', e.target.checked)}
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600"></div>
                </label>
              </div>
          ...
          >
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 rounded-full bg-emerald-100 flex items-center justify-center mb-4">
                <FaUsersCog className="text-emerald-500 text-4xl" />
              </div>
